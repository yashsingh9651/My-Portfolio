    ...
    <>
      ...
      <div className="relative w-screen z-50">
        ...
        <div className="w-4/5 h-screen mx-auto flex flex-col justify-center items-center text-center">
          {/* Heading */}
          <h1 className="text-lg text-white font-semibold pb-4 md:text-4xl font-[Phudu]">
          ...
          <div className="relative w-full h-[60vh] lg:flex lg:justify-between lg:items-center sm:h-[50vh] md:h-[60vh] rounded backdrop-blur-sm">
            ...
            <div
              className={`w-[150px] h-[150px] rounded md:w-[275px] border border-white overflow-hidden md:h-[275px] absolute top-3 right-20 sm:left-20 md:left-40 md:top-16`}
            >
              ...
              <form ref={form} onSubmit={handleSubmit}>
                ...
                <div className="relative">
                  <input
                    ...
                    onBlur={handleBlur}
                    className="rounded px-2 p-1 m-1 w-full sm:text-sm lg:text-lg"
                    type="text"
                    name="name"
                    placeholder="Name"
                    value={values.name}
                ...
                <div className="relative">
                  <textarea
                    ...
                    className="resize-none rounded px-2 p-1 m-1 w-full sm:text-sm lg:text-lg sm:h-[8vw]"
                    name="message"
                    placeholder="Message"
                    autoComplete="off"
                  ></textarea>
                ...
                {/* Submit Button */}
                <input
                  className="p-1 w-full m-1 rounded bg-white active:scale-90 font-semibold hover:bg-[rgba(255,255,255,0.7)] sm:font-extralight sm:text-sm lg:font-bold lg:text-xl"
                  type="submit"
                  value="Send"
                />
              </form>
            ...
            <div className="z-50 absolute bottom-0 w-full font-[Arvo] sm:hidden md:block lg:hidden">
              <form ref={form} onSubmit={handleSubmit}>
                ...
                <input
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className="rounded px-2 p-1 m-1 w-11/12 md:text-2xl"
                  type="text"
                  name="name"
                  placeholder="Name"
                  value={values.name}
                ...
                <textarea
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className="resize-none rounded px-2 p-1 m-1 w-11/12 md:text-2xl h-[20vw]"
                  name="message"
                  placeholder="Message"
                  value={values.message}
                  autoComplete="off"
                ></textarea>
                <input
                  className="p-1 w-11/12 m-1 mb-5 rounded bg-white active:scale-90 font-semibold md:font-bold md:text-3xl md:mb-1"
                  type="submit"
                  value="Send"
                />
              </form>
